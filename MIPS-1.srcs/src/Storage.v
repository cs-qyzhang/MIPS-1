...
module Storage(addr, din, mode, we, clk, rst, dout);
    ...
    assign  out[7:0]   = sel[0] ? ram_out[7:0]   : 8'b0;
    assign  out[15:8]  = sel[1] ? ram_out[15:8]  : 8'b0;
    assign  out[23:16] = sel[2] ? ram_out[23:16] : 8'b0;
    assign  out[31:24] = sel[3] ? ram_out[31:24] : 8'b0;

    assign  dout = i_24 ? (out >> 24) : (i_16 ? (out >> 16) : (i_8 ? (out >> 8) : out));
