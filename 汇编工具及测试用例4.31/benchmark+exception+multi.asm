...
# 保护EPC， STATUS
mfc0 $k1, $14       # EPC, Get restart address
sw $k1, 48($k0)     # Save epc in memory    固定位置，两级中断以上有问题！！！
mfc0 $k1, $12       # Get Status
sw $k1, 52($k0)     # Save Status
mfc0 $t1, $13       # Get Cause
addi $k1, $0, 0xff00
and $t1, $t1, $k1
srl $t1, $t1, 8
addi $s0, $0, 0
...
# 恢复EPC， STATUS
lw $k1, 48($k0)     # Save epc in memory    固定位置，两级中断以上有问题！！！
mtc0 $k1, $14       # EPC, Get restart address
lw $k1, 52($k0)     # Save Status
srl $k1, $k1, 1
sll $k1, $k1, 1
mtc0 $k1, $12       # Get Status
